...
//void NewRemoteReceiver::init(int8_t interrupt, unsigned short minRepeats, NewRemoteReceiverCallBack callback) {
NewRemoteReceiver::NewRemoteReceiver(int8_t interrupt, unsigned short minRepeats, NewRemoteReceiverCallBack callback) {
